...
[พระเจ้า]รูัสึกสมเพชในตัวคุณ""")
    ...
    if choice == "9 มม.ฝังเวทย์":
        typing("\n\033[1;30;40mเสียงลึกลับ\033[0;37;40m : \"ว้าวววว!!! ท่าน %s ท่านช่างดูเหยาะแหยะปวกเปียกและน่าสมเพชเหลือเกิน ข้าคือ %s ไม่ทราบว่าท่านเป็นผู้กลับชาติมาเกิดใช่รึไม่?\""%(st.Player["name"], god))
